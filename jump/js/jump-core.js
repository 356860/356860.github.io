...
export const JUMP_CONFIG = {
    ...
    preloadHipMax: 160,
    preloadMinFrames: 3,
    preloadDrillEnterKneeMax: 145,
    preloadDrillEnterHipMax: 138,
    preloadDrillTargetKneeMin: 82,
    preloadDrillTargetKneeMax: 128,
    preloadDrillTargetHipMax: 112,
    preloadDrillArmBackMin: 0.16,
    preloadDrillArmLiftMin: 0.05,
    preloadDrillUsableKneeMax: 132,
    preloadDrillUsableHipMax: 118,
    preloadDrillUsableArmBackMin: 0.14,
    preloadDrillExtendKneeMin: 150,
    preloadDrillExtendHipMin: 138,
    preloadDrillExtendDeltaMin: 20,
    preloadDrillTimeoutFrames: 30,
    ...
    sideReadyFrames: 3,
    fullPreloadKneeWeak: 136,
    fullPreloadHipWeak: 126,
    fullArmBackWeak: 0.11,
    fullArmForwardWeak: 0.042,
    fullTakeoffRiseWeak: 0.011,
    fullFlightFramesMin: 2,
...
export function createAttemptState(baseline) {
    return {
        ...
        maxFlightHipAngle: 0,
        preloadMinKneeAngle: 180,
        preloadMinHipAngle: 180,
        preloadMaxWristBack: 0,
        flightFrames: 0,
